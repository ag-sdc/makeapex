...
[[ -n "$LIBMAKEAPEX_LINT_APEXBUILD_CHECKDEPENDS_SH" ]] && return
LIBMAKEAPEX_LINT_APEXBUILD_CHECKDEPENDS_SH=1
...
lint_apexbuild_functions+=('lint_checkdepends')


lint_checkdepends() {
	local checkdepends_list checkdepend name ver ret=0

	get_apexbuild_all_split_attributes checkdepends checkdepends_list
