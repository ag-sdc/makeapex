...
[[ -n "$LIBMAKEAPEX_LINT_APEXBUILD_CHANGELOG_SH" ]] && return
LIBMAKEAPEX_LINT_APEXBUILD_CHANGELOG_SH=1
...
source "$MAKEAPEX_LIBRARY/lint_apexbuild/util.sh"


lint_apexbuild_functions+=('lint_changelog')
