...
[[ -n "$LIBMAKEAPEX_LINT_APEXBUILD_FULLPKGVER_SH" ]] && return
LIBMAKEAPEX_LINT_APEXBUILD_FULLPKGVER_SH=1

MAKEAPEX_LIBRARY=${MAKEAPEX_LIBRARY:-"$(dirname "$0")/libmakeapex"}

source "$MAKEAPEX_LIBRARY/lint_apexbuild/epoch.sh"
source "$MAKEAPEX_LIBRARY/lint_apexbuild/pkgrel.sh"
source "$MAKEAPEX_LIBRARY/lint_apexbuild/pkgver.sh"
