...
[[ -n "$LIBMAKEAPEX_LINT_CONFIG_SH" ]] && return
LIBMAKEAPEX_LINT_CONFIG_SH=1

MAKEAPEX_LIBRARY=${MAKEAPEX_LIBRARY:-'/usr/share/makeapex'}
...
for lib in "$MAKEAPEX_LIBRARY/lint_config/"*.sh; do
	source "$lib"
done
