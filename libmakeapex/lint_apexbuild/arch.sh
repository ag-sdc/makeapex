...
[[ -n "$LIBMAKEAPEX_LINT_APEXBUILD_ARCH_SH" ]] && return
LIBMAKEAPEX_LINT_APEXBUILD_ARCH_SH=1
...
lint_apexbuild_functions+=('lint_arch')
...
validate_arch_override() {
	...
	get_apexbuild_attribute "$package" 'arch' 1 override
