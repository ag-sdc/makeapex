...
[[ -n "$LIBMAKEAPEX_UTIL_OPTION_SH" ]] && return
LIBMAKEAPEX_UTIL_OPTION_SH=1
...
##
# Checks to see if options are present in makeapex.conf or APEXBUILD;
# APEXBUILD options always take precedence.
#
...
##
# Checks to see if options are present in BUILDENV or APEXBUILD;
# APEXBUILD options always take precedence.
#
